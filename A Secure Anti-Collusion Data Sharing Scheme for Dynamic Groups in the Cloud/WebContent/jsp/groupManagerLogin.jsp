...
<title>Group Manager Login Page</title>
...
<body>
	<div id="header">
		<div class="section">
			...
			<ul>
				...
				<li class="selected"><a href="groupManagerLogin.do">G
						Manager</a></li>
	...
	<div id="body">
		...
		<div>
			...
			<h3 style="font-family: cursive;">Group Manager Login Page</h3>

			<p style="font-family: cursive; color: red;">${LOGIN_STATUS}</p>

			<form name="loginForm" action="./gManagerLogin.do" method="post">
				<table>
					<tr>
